...
public class SetUpTest {
    ...
    public static void setUp(){
        ...
        MongoCollection<Document> transactionCollection = db.getCollection("TransactionTest");
        TransactionDAO.initCollection(transactionCollection);

        Document filter = new Document("author", "Author1");
        FindIterable<Document> prefabBooks = bookCollection.find(filter);
